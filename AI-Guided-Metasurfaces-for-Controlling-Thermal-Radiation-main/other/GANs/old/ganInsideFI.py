...
Original file is located at
    https://colab.research.google.com/drive/1hoeb39GI6rV88F0IWvxoXPV0YC7TOtaQ
"""
...
# Path to zip file
zip_path = '/content/drive/MyDrive/a_circles_data.zip'

# Destination folder to unzip
extract_to = '/content/drive/MyDrive/UNTAI/Full_Data/Data_Optical_Output'
...
dataroot = "/content/drive/MyDrive/UNTAI/Full_Data" # e.g., "/content/My_Metasurface_Data"
...
import os
dataroot = "/content/drive/MyDrive/UNTAI/Data/Data"
print(f"Path exists: {os.path.exists(dataroot)}")
print(f"Contents: {os.listdir(dataroot) if os.path.exists(dataroot) else 'Path not found'}")

import os
from PIL import Image

dataroot = "/content/drive/MyDrive/UNTAI/Data/Data"  # Your confirmed path

# Check image integrity
for category in os.listdir(dataroot):
    category_path = os.path.join(dataroot, category)
    if os.path.isdir(category_path):
        for file in os.listdir(category_path)[:3]:  # Check first 3 files
